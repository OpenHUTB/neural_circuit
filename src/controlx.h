...
double dftc;			/* synaptic time constant */
double dftm;            	/* channel time constant for 2ndmsg (mglu) */
double dsgm;            	/* gain for 2ndmsg (mglu) */
...
double dvfbg;			/* gain for voltage feedback from transrate */
double dvfbo;			/* offset for voltage feedback from transrate */
...
double dachu;			/* unitry cond for ACh channel   */
...
double dcacomplen;          	/* default Ca compartment length (um) */
double dcashd;          	/* default Ca shell depth (um) */
...
double unmaskthr;	/* neg threshold for unmasking light   */
double unmaskthr2;	/* pos threshold for unmasking light (i.e. Vm)  */
