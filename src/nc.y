...
%token	<sym>	FB0 FB1 FB2 FB3 FB4 FC0 FC1 FC2 FC3 FC4 FC9 FD0 FD1
...
%token  <sym>	CA CAO CAI TCAI CACOMP CADIA IP IE IPE BTOT BTOTI 
...
%token  <sym>   GLU AMPA KAINATE NMDA ACH CNQX GABA BIC PTX GLY VFB 
%token  <sym>   CHRC STRY CAMP CGMP MLA HEX PH ATP
%token  <sym>   LPFILT LP HP MFILT BESSFILT
%token	<sym>	GAUSNN NND NNSTD GINFO REG COV REFR 
%token	<sym>	NOTINIT VARNUM VARSTR VARCHR 
%token	<sym>	LINEAR EXPON NFILT1 NFILT1H NFILT2 NFILT3 NFILTM
%token	<sym>	RESP MESGIN MESGOUT SYN2 LOOPG
%token	<sym>	TIMEC1 TIMEC1H TIMEC2 TIMEC3 TIMECM TFALL2 TFALL3 TFALLM
...
gjtype:  expr 			{ code2(xgj,(Inst)0); }
	...
	| gjtype MESGIN secondmsg nodenum { code3(xgj,(Inst)(long long)$3,(Inst)(long long)$4); }
...
memparm:   RM 
	...
	|  VREST 
	;
connect:   AT begin nodenum  	{ $$=$2; code2(conn1,(Inst)(long long)$3); } 
	|  AT begin nodenum LOC parglist     /* args backwards here: */ 
				{ $$=$2; code3(conn1l,(Inst)(long long)$5,(Inst)(long long)$3); } 

	|  AT begin nodenum ':' elemnum OFFSET setexpr PUT nodenum
				{ $$=$2; code3(conn1m,(Inst)(long long)$9, (Inst)(long long)$3); }

	|  CONNECT begin nodenum TO nodenum   /* args backwards here */
				{ $$=$2; code2(conn2d,(Inst)(long long)$5);
					 code2(conn2s,(Inst)(long long)$3); } 

	|  CONNECT begin nodenum LOC parglist TO nodenum
				{ $$=$2; code2(conn2d,(Inst)(long long)$7);
					 code3(conn2sl,(Inst)(long long)$5,(Inst)(long long)$3); }

	|  CONNECT begin nodenum TO nodenum LOC parglist
				{ $$=$2; code3(conn2dl,(Inst)(long long)$7,(Inst)(long long)$5);
					 code2(conn2s,(Inst)(long long)$3); }

					/* args backwards here: */	
	|  CONNECT begin nodenum LOC parglist TO nodenum LOC parglist
				{ $$=$2; code3(conn2dl,(Inst)(long long)$9,(Inst)(long long)$7);
					 code3(conn2sl,(Inst)(long long)$5,(Inst)(long long)$3); } 
	|  MODIFY expr		{ $$=$2; code2(xmod,(Inst)$1); }
	;
synaptype: SYNAPSE begin		{ $$=$2;  code2(xsynapse,(Inst)0); } 
	...
	|  synaptype timectype '[' timecspec ']'
					{ code3(xsynapse,(Inst)$2,(Inst)(long long)$4); } 
...
nfilt:     NFILT1 setexpr		{ $$=$2; code2(xsynapse,(Inst)$1); }
	...
	|  NFILTM setexpr		{ $$=$2; code2(xsynapse,(Inst)$1); }
	;
timectype: TIMEC1
	|  TIMEC1H 
	|  TIMEC2
...
transducer: ROD				{ }
	...
	|   ITRANSDUCER			{ }
	;
receptype: transducer begin parglist  { $$=$2;code3(xphotrec,(Inst)$1,(Inst)(long long)$3);}
...
stimulus:  stimparm	{}
	...
	;
stimparm:  stimtype     {}
	|  LOC    begin parglist { $$=$2; code3(xstim,(Inst)$1,(Inst)(long long)$3); }
	|  CENTER begin parglist { $$=$2; code3(xstim,(Inst)$1,(Inst)(long long)$3); }
	...
	|  SCATTER begin parglist { $$=$2; code3(xstim,(Inst)$1,(Inst)(long long)$3); }
	|  stimwave	{}
	|  stiminten	{}
	|  stimfile	{}
	;
stimtype:  BAR expr 	{ $$=$2; code2(xstim,(Inst)$1); }
	...
	|  RECT begin arglist 	{ $$=$2; code3(xstim,(Inst)$1,(Inst)(long long)$3); }
	|  CHECKERBOARD begin arglist { $$=$2; code3(xstim,(Inst)$1,(Inst)(long long)$3); }
	|  transducer expr 	{ $$=$2; code3(xstim,(Inst)$1,(Inst)1);}
	|  transducer begin dimlist { $$=$2; code3(xstim,(Inst)$1,(Inst)(long long)$3);}
	|  NODE begin nodenum 	{ $$=$2; code3(xstim,(Inst)$1,(Inst)(long long)$3);}
...
asgn:	  var '=' expr 	 { code(assign); }
	...
	;
within:				   { $$ = 0; }	/* nothing */
	| WITHIN2D expr NODE nodenum { $$ = (Inst*)(long long) $4; }
	| WITHIN3D expr NODE nodenum { $$ = (Inst*)(long long) -$4; }
...
stmt:     expr { code(expop); } 
	...
	| PROCEDURE begin parglist 
		{ $$=$2; code3(call, (Inst)$1, (Inst)(long long)$3); }
	| VAR begin parglist 
		{ $$=$2; code3(call, (Inst)$1, (Inst)(long long)$3); }
	| defn 	{ } 
	| EXIT { $$=code(xexit); }
	...
	| PRINTF  begin '(' prflist ')'{ $$=$2; code2(pprintf,(Inst)(long long)$4);}
	| SPRINTF begin '(' sprflist ')'{ $$=$2; code2(psprintf,(Inst)(long long)$4);}
	| FPRINTF begin '('expr','prflist')'{$$=$2; code2(pfprintf,(Inst)(long long)$6);}
	...
	| FREAD begin '(' filename ',' arrayname ',' vararg ')'
		{ $$=$2; code3(xfread,(Inst)$6,(Inst)(long long)$8); $6->type=ARRAY; }
	| FREADS begin '(' filename ',' arrayname ',' vararg ')'
		{ $$=$2; code3(xfreads,(Inst)$6,(Inst)(long long)$8); $6->type=ARRAY; }
	| FWRITE begin '(' filename ',' ARRAY ')'
		{ $$=$2; code2(xfwrite,(Inst)$6); }
	| UNLINK begin '(' filename ')'
		{ $$=$2; code(xunlink); }
	| DIM begin arrayname dimlist  { $$=$2; 
	  code3(darray,(Inst)$3,(Inst)(long long)$4); $3->type=ARRAY; 
			$3->arrp= (ncarray*)NULL; }
	| DIM begin arrayname dimlist { $$=$2; 
	  code3(darray,(Inst)$3,(Inst)(long long)$4); $3->type=ARRAY; 
 		$3->arrp= (ncarray*)NULL; }
		'=' initlist 
		{$$=$2; code3(initarr,(Inst)$3,(Inst)(long long)$7);}
	| DIM begin arrayname '[' ']' '=' initlist { $$=$2; 
	  code4(darray,(Inst)$3,(Inst)0,(Inst)(long long)$7); $3->type=ARRAY; 
 		$3->arrp= (ncarray*)NULL; code3(initarr,(Inst)$3,(Inst)(long long)$7);}
	...
	| ERASE NODE begin nodenum { $$=$3; code2(eranode, (Inst)(long long)$4); }
...
gnnterm:  N setexpr		{ $$=$2; code2(xgausnn,(Inst)$1); } 
	...
	| SIZE begin parglist	{ $$=$2; code3(xgausnn,(Inst)$1,(Inst)(long long)$3); } 
	| CENTER begin parglist	{ $$=$2; code3(xgausnn,(Inst)$1,(Inst)(long long)$3); } 
	;
fftparm:   FFT			{ }
	| IFFT			{ }
	| PFFT			{ }
...
plotypef: CABUFB  '(' expr ')'	{ $$=$3; }
	;
plotlist:
	  plotype  begin nodenum { $$=$2; code3(vplot,(Inst)$1,(Inst)(long long)$3); }
	| plotypec begin nodenum { $$=$2; 
				code4(vplot,(Inst)CA,(Inst)(long long)$3,(Inst)(long long)$1); }
	| plotyped nodenum { $$=$1; code4(vplot,(Inst)CA,(Inst)(long long)$2,(Inst)1); }
	| plotypeb nodenum { $$=$1; code4(vplot,(Inst)CABUF,(Inst)(long long)$2,(Inst)1); }
	| plotypef nodenum { $$=$1; code4(vplot,(Inst)CABUFB,(Inst)(long long)$2,(Inst)1); }
	| plotypee begin elemnum { $$=$2; code3(vplot,(Inst)$1,(Inst)1); }
	| plotypeg begin elemnum { $$=$2; 
				code4(vplot,(Inst)G,(Inst)1,(Inst)(long long)$1); }
	...
	| plotlist ',' plotype nodenum
				{ $$=$1; code3(vplot,(Inst)$3,(Inst)(long long)$4);}
	| plotlist ',' plotypec nodenum
		{ $$=$1; code4(vplot,(Inst)CA,(Inst)(long long)$4,(Inst)(long long)$3);}
	| plotlist ',' plotyped nodenum
		{ $$=$1; code4(vplot,(Inst)CA,(Inst)(long long)$4,(Inst)1);}
	| plotlist ',' plotypeb nodenum
		{$$=$1; code4(vplot,(Inst)CABUF,(Inst)(long long)$4,(Inst)1);}
	| plotlist ',' plotypef nodenum
		{$$=$1; code4(vplot,(Inst)CABUFB,(Inst)(long long)$4,(Inst)1);}
	| plotlist ',' plotypee elemnum
				{ $$=$1; code3(vplot,(Inst)$3,(Inst)1);}
	| plotlist ',' plotypeg elemnum
		{ $$=$1; code4(vplot,(Inst)G,(Inst)1,(Inst)(long long)$3);}
	...
	| plotlist plltyp 	{ $$=$1; }
	;
gprim:    GMOVE begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GDRAW begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GRMOVE begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GRDRAW begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GCIRC begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GRECT begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GPEN  begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GVPEN begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GROT  begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GORIG begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GCWID begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GCROT begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GDASH begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GSIZ begin parglist	{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GWINDOW begin parglist{ $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GFRAME begin parglist { $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GPURGE begin parglist { $$=$2;    code3(gplot,(Inst)$1,(Inst)(long long)$3); }
	| GTEXT begin '(' prflist ')'{ $$=$2; code2(txtf,(Inst)(long long)$4);}
	| GLABEL begin '(' prflist ')'{ $$=$2; code2(gglabel,(Inst)(long long)$4);}
	;
graphlist: graphtype		{ $$=$1; }
	| graphlist graphtype 	{ $$=$1; }
	;
graphtype: begin parglist 	{ $$=$1;      code3 (grph, (Inst)0L,(Inst)(long long)$2);}
	| INIT			{ $$=(Inst *) code3 (grph,(Inst)$1, (Inst)0L); }
	| RESTART		{ $$=(Inst *) code3 (grph,(Inst)$1, 0L); }
	| PEN begin parglist	{ $$=$2;      code3 (grph,(Inst)$1,(Inst)(long long)$3);}
...
grltyp:   CHAR setexpr		{ $$=$2; code3 (grph,(Inst)$1, (Inst)-1); }
	...
	| FILT begin '[' timecspec ']'{$$=$2;code3 (grph,(Inst)$1,(Inst)(long long)$4);} 
...
plltyp:   CHAR setexpr		{ $$=$2; code3 (plparams,(Inst)$1, (Inst)-1); }
	...
	| FILT begin '[' timecspec ']'{$$=$2;code3 (plparams,(Inst)$1,(Inst)(long long)$4);} 
...
disptype: MATCHING begin nodenum
			  { $$=$2; code4(dispnod,(Inst)$1,(Inst)0,(Inst)(long long)$3); }
	| CONNECT begin nodenum TO nodenum
			  { $$=$2; code4(dispnod,(Inst)$1,(Inst)(long long)$5,(Inst)(long long)$3); }
	...
	| WINDOW begin parglist  { $$=$2; code3(dispnod,(Inst)$1,(Inst)(long long)$3); } 
	...
	| CALIBLIN setexpr LOC parglist
			   { $$=$2; code3(dispnod,(Inst)$1,(Inst)(long long)$4);} 
	| HIDE 	 	  { $$=(Inst *)code2(dispnod,(Inst)$1); } 
	| CENTER begin parglist { $$=$2; code3(dispnod,(Inst)$1,(Inst)(long long)$3); } 
	| RMOVE  begin parglist { $$=$2; code3(dispnod,(Inst)$1,(Inst)(long long)$3); } 
...
stmtlist: '{' stmtls '}'	{ $$ = $2; }
	| '{' begin localdef listerm stmtls '}'	
		{ $$ = $2; code2(locend,(Inst)(long long)(-$3+1+argcount));
...
expr:	  NUMBER     { $$ = (Inst *)code2(constpush, (Inst)$1); }
	| CONST	     { $$ = 
		(Inst *)code4(varpush,(Inst)(long long)$1->type,(Inst)$1,evalvar);}
	| initlist  { $$ = 
		(Inst *)code4(varpush,(Inst)ARRAYCONST,(Inst)(long long)$1,evalvar);} 
	| DIMS '(' var ')' {  code(xdims); }
	...
	| TYPE '(' expr ')' { $$=code(gettype); }
	| NTYPE '(' elemtype ')' { $$=code2(getntype,(Inst)$3); }
	| BLTIN begin parglist { 
			 $$=$2; code3(bltin,(Inst)(long long)$3,(Inst)$1->ptr);}
	...
	| SCANF  begin '(' scnflist ')'      { $$=$2; code2(pscanf,(Inst)(long long)$4);}
	| FSCANF begin '(' expr ','scnflist')'{$$=$2; code2(pfscanf,(Inst)(long long)$6);}
	| SSCANF begin'(' expr ',' scnflist ')'{$$=$2; code2(psscanf,(Inst)(long long)$6);}
	| comndline		{ } 
	| plotype begin nodenumex
				 { $$=$2; code3(xrecord, (Inst)$1, (Inst)(long long)$3); }
	| plotypec begin nodenumex
			{ $$=$2; code4(xrecord, (Inst)CA, (Inst)(long long)$3, (Inst)(long long)$1); }
	| plotyped nodenumex
			{ $$=$1; code4(xrecord, (Inst)CA, (Inst)(long long)$2, (Inst)1); }
	| plotypeb nodenumex
			{ $$=$1; code4(xrecord, (Inst)CABUF,(Inst)(long long)$2,(Inst)1);}
	| plotypef nodenumex
			{ $$=$1; code4(xrecord, (Inst)CABUFB,(Inst)(long long)$2,(Inst)1);}
	| plotypee begin elemnum
				 { $$=$2; code3(xrecord, (Inst)$1, (Inst)1); }
	| plotypeg begin elemnum
			{ $$=$2; code4(xrecord, (Inst)G, (Inst)1, (Inst)(long long)$1); }
	| plotypeh elemnum
	...
	| E3DIST begin '(' nodenum ',' elemnum ')'
				 { $$=$2; code2(e3dist, (Inst)(long long)$4); }
	| E2DIST begin '(' nodenum ',' elemnum ')'
				 { $$=$2; code2(e2dist, (Inst)(long long)$4); }
	| EZDIST begin '(' nodenum ',' elemnum ')'
				 { $$=$2; code2(ezdist, (Inst)(long long)$4); }
	| EFRAC begin '(' nodenum ',' elemnum ')'
				 { $$=$2; code2(efrac, (Inst)(long long)$4); }
	| N3DIST begin '(' nodenum ',' nodenum ')'  /* args are backward here: */
				 { $$=$2; code3(n3dist, (Inst)(long long)$6, (Inst)(long long)$4); }
	| N2DIST begin '(' nodenum ',' nodenum ')'  /* args are backward here: */
				 { $$=$2; code3(n2dist, (Inst)(long long)$6, (Inst)(long long)$4); }
	| NZDIST begin '(' nodenum ',' nodenum ')'  /* args are backward here: */
				 { $$=$2; code3(nzdist, (Inst)(long long)$6, (Inst)(long long)$4); }
	...
	| NODE begin nodenum PFIELD nodefield 
				{ $$=$2; code3(nfield,(Inst)$5, (Inst)(long long)$3);}
	| '(' cexpr ')'	{ $$ = $2; }
	| expr '+' expr { code (add); }
	| expr '-' expr { code (sub); }
	| expr '*' expr { code (mul); }
...
setexpr:  expr		{ $$ = $1; }
	| "=" expr	{ $$ = $2; }
	;
var:	  VAR	   { $$=(Inst*)code3(varpush,(Inst)(long long)$1->type,(Inst)$1); }
	| ARRAY begin dimlist{ $$ = $2;
		code4(varpush,(Inst)ARRAYVAL,(Inst)$1,(Inst)(long long)$3);}

	| ARRAY { $$ = code4(varpush,(Inst)(long long)$1->type,(Inst)$1,(Inst)0);}

	| LOCALARR { $$ = code4(varpush,(Inst)(long long)$1->type,(Inst)(long long)$1->argnum,(Inst)0);}

	| LOCALARR begin dimlist{ $$ = $2; 
		code4(varpush,(Inst)LOCALARRVAL,(Inst)(long long)$1->argnum,(Inst)(long long)$3);}

	| ARG	   {$$=(Inst *)code3(varpush,(Inst)(long long)$1->type,(Inst)(long long)$1->argnum);}
	| ARG begin dimlist {$$ = $2;
		code4(varpush,(Inst)ARGARRVAL,(Inst)(long long)$1->argnum,(Inst)(long long)$3);}
	| LOCALVAR {$$=(Inst *)code3(varpush,(Inst)(long long)$1->type,(Inst)(long long)$1->argnum);}
	;
...
localvar: LOCALVAR  		{ $$ = 1; $1->argnum = ++argcount; } 
	| localarrdef dimlist 
			{ inlocal=savlocal; $$ = 1; 
			code3(dlocarray,(Inst)(long long)++argcount,(Inst)(long long)$2); 
	...
	| localarrdef dimlist 
		...
		'=' initlist 
		{ $$ = 1; 
		inlocal=savlocal; code3(initarr,(Inst)0,(Inst)(long long)$5);}

        | localarrdef '[' ']' '=' initlist
		{ $$=1; code4(dlocarray,(Inst)(long long)++argcount,(Inst)0,(Inst)(long long)$5);
		 code2(stackmove,(Inst)(long long)$5); 
	...
	| localvar ',' localarrdef dimlist 
			...
			code3(dlocarray,(Inst)(long long)++argcount,(Inst)(long long)$4); 
	...
	| localvar ',' localarrdef dimlist 
		{ code3(dlocarray,(Inst)(long long)++argcount,(Inst)(long long)$4); 
		  $3->argnum=argcount; arrcount++; $3->type=LOCALARR; } 
			'=' initlist 
		{ $$ = $1 + 1; 
		inlocal=savlocal; code3(initarr,(Inst)0,(Inst)(long long)$7);}

        | localvar ',' localarrdef '[' ']' '=' initlist
		{ $$=$1+1; code4(dlocarray,(Inst)(long long)++argcount,(Inst)0,(Inst)(long long)$7);
		 code2(stackmove,(Inst)(long long)$7); 
		$3->argnum=argcount; arrcount++; $3->type=LOCALARR; 
		inlocal=savlocal; code3(initarr,(Inst)0,(Inst)(long long)$7); }
...
localdef: LOCAL { inlocal=argcount+1; arrcount=0; } localvar 
		...
		(Inst *)code3(local,(Inst)(long long)$3,(Inst)(long long)arrcount); }
        | localdef listerm LOCAL { inlocal=argcount+1; arrcount=0; } localvar 
    	    { $$=$1; inlocal=0; (Inst *)code3(local,(Inst)(long long)$5,(Inst)(long long)arrcount); }
	;
vararg:  var			{ $$ = 1; }
	| vararg ',' var	{ $$ = $1 + 1; }
	;
