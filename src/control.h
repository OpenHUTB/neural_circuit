...
extern double dftc;		/* synaptic time constant */
extern double dftm;		/* channel time constant for 2nd msg (mglu) */
extern double dsgm;		/* gain for 2nd msg (mglu) */
...
extern double dvfbg;		/* gain for voltage feedback from transrate */
extern double dvfbo;		/* offset for voltage feedback from transrate */
...
extern double dachu;		/* unitary cond for ACh channel    */ 
...
extern double dcacomplen;	/* default Ca compartment length (um) */
extern double dcashd;		/* default Ca shell depth (um) */
...
extern double unmaskthr;	/* neg threshold for unmasking light   */
extern double unmaskthr2;	/* pos threshold for unmasking light (i.e. Vm) */
