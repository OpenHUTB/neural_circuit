...
struct synapse: elem {
	...
	double *timecm;			/* time const for syn filter */
	...
	short int nfiltm; 		/* num of low pass filters */
	...
	double tfallm; 			/* falling tau for synapse */
	...
	float rextern; 			/* external resistance */
...
struct cattrib: chattrib {		/* part of an element */
	...
	double cadia;			/* diameter of Ca comp. */
