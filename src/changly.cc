...
double calcgly1(double v, int func) {return 0;}
...
*/

  {
   ...
   spnt[0].trans  [0] = 1;
   spnt[0].trate  [0] = rnt;
   spnt[0].ratemul[0] = 20e5;
   spnt[0].rateo  [0] = 0;		/* taua */

   spnt[1].numtrans   = 3;
   spnt[1].cond       = 0;
   spnt[1].trans  [0] = 2;
   spnt[1].trate  [0] = rnt;
   spnt[1].ratemul[0] = 10e5;
   spnt[1].rateo  [0] = 0;		/* taua */
   spnt[1].trans  [1] = 0;
   spnt[1].trate  [1] = rt;
   spnt[1].ratemul[1] = 4.6e3;
   spnt[1].rateo  [1] = 1;		/* taub */
   spnt[1].trans  [2] = 3;
   spnt[1].trate  [2] = rt;
   spnt[1].ratemul[2] = 3.3e3;
   spnt[1].rateo  [2] = 2;		/* tauc */
   ...
   spnt[2].rateo  [0] = 2;		/* tauc */
   spnt[2].trans  [1] = 1;
   spnt[2].trate  [1] = rt;
   spnt[2].ratemul[1] = 9.2e3;
   spnt[2].rateo  [1] = 1;		/* taub */

   spnt[3].numtrans   = 1;
   spnt[3].cond       = 1.0;
   spnt[3].trans  [0] = 1;		/* state 3, open state */
   spnt[3].trate  [0] = rt;
   spnt[3].ratemul[0] = 9.8e3;
   spnt[3].rateo  [0] = 3;		/* taud */
