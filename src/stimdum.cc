...
datum    minf(datum &v, datum &elname){return null_datum;}
datum    mtau(datum &v, datum &elname){return null_datum;}
datum    hinf(datum &v, datum &elname){return null_datum;}
datum    htau(datum &v, datum &elname){return null_datum;}
...
datum    ctaua(datum &v, datum &elname){return null_datum;}
datum    ctaub(datum &v, datum &elname){return null_datum;}
datum    ctauc(datum &v, datum &elname){return null_datum;}
datum    ctaud(datum &v, datum &elname){return null_datum;}
datum    ctaue(datum &v, datum &elname){return null_datum;}
datum    ctauf(datum &v, datum &elname){return null_datum;}
datum    (copychan) (datum &sc, datum &ss, datum &dc, datum &ds,
                                        datum &nstates){return null_datum;}
datum    (setchan_ntrans)(datum &sc, datum &ss, datum &state, datum &val){return null_datum;}
datum    (setchan_cond) (datum &sc, datum &ss, datum &state, datum &val){return null_datum;}
datum    (setchan_trans)(datum &sc,datum &ss, datum &state, datum &trans,
                                        datum &val){return null_datum;}
...
datum    (setchan_rateo)(datum &sc,datum &ss, datum &state, datum &trans,
                                        datum &val){return null_datum;}
datum    (call_set2ndmsg) (datum &ctype, datum &stype, datum &prect, datum &postct,
		                         datum &maxdist, datum &gain, datum &mtype){return null_datum;}

double gjalpha (double v, gj *gjpnt) {return 0;}
double gjbeta  (double v, gj *gjpnt) {return 0;}
