...
#define MAXPARM 2000			/* used in modcode.cc to separate params */
...
#define LARGERES 1e35			/* large resistor for blank comp */
...
#define CACOMPRAD 2.5			/* default calcium comp radius in um */
...
#define RNCOLOR   32765 		/* display color from cell region number */
#define CACOLOR   32764			/* display color from [Ca]i */
#define NAACOLOR  32763 		/* display color from Na activated state */
#define NAICOLOR  32762 		/* display color from Na inactivated state */
#define KACOLOR   32761 		/* display color from K state */
#define SGCOLOR   32760 		/* display color from syn cond */
#define SRCOLOR   32759 		/* display color from syn rate */
