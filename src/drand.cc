...
/* for"rnd_taus113.cc" (from Gnu Sci Library), use these definitions: */
...
/* for"rnd_taus258.cc" (from https://apps.dtic.mil/sti/pdfs/AD1024837.pdf), use these definitions: */
/*
#define rinitstate    taus258_init
#define rsetstate     taus258_setstate
#define random        taus258_get
#define random_double taus258_get_double

#define RANDSTATSIZ (5*sizeof(long long int))

void taus258_init(unsigned long long int seed, void *state, int n);
void taus258_setstate(void *state);
