...
elem *make_conn (node *n1, node *n2, int elemtype);
...
photorec *make_transducer(node *node, double xpos, double ypos, int stimchan);
photorec *make_transducer(node *node, double xpos, double ypos);
photorec *make_transducer(node *node, int stimchan);
...
void stim_sine(double speriod, double sphase, double orient,
		double xloc, double yloc, double xcent, double ycent,
		double tfreq, int drift, double scale,
		double inten_mult, double contrast, int ssq, int tsq, 
		double start, double dur, double wavel, double mask, int stimchan);
...
void stim_sine(double speriod, double sphase, double orient, 
		double xloc, double yloc, double tfreq, int drift,
		double inten_mult, double contrast, int ssq, int tsq, double start, double dur);
...
void stim_gabor(double speriod, double sphase, double orient,
		...
		double inten_add, double inten_mult, double contrast, 
		double xenv, double yenv, int ssq, int tsq,
		double start, double dur, double wavel, double mask, int stimchan);

void stim_gabor(double speriod, double sphase, double orient,
		double xloc, double yloc, double xcent, double ycent,
		double tfreq, double drift, double scale,
		double inten_mult, double contrast, double xenv, double yenv, int sq, int tsq,
		double start, double dur, double wavel, double mask, int stimchan);
...
void stim_gabor(double speriod, double sphase, double orient, double xloc, double yloc,
		...
		double xenv, double yenv, int sq, int tsq, double start, double dur);
...
void stim_sineann(double speriod, double sphase, double xloc, double yloc,
		...
		double start, double dur, double wavel, double mask, int stimchan); /* 20 */

void stim_sineann(double speriod, double sphase, double xloc, double yloc,
		double xcent, double ycent, double tfreq, double drift, double scale,
		double inten_mult, double contrast, double xenv, int makenv, int sq,
		double start, double dur, double wavel, double mask, int stimchan); /* 19 */

void stim_sineann(double speriod, double sphase, double xloc, double yloc,
		double xcent, double ycent, double tfreq, double drift, double scale,
		double inten_mult, double contrast, double xenv, int sq,
		double start, double dur, double wavel, double mask, int stimchan); /* 18 */

void stim_sineann(double speriod, double sphase, double xloc, double yloc,
		double tfreq, double drift, double inten_add, double
		inten_mult, double contrast, double renv, int makenv, int sq,
		double start, double dur);					   /* 14 */

void stim_sineann(double speriod, double sphase, double xloc, double yloc,
		double tfreq, double drift, double inten_add, double
		inten_mult, double contrast, double renv, int sq, double start,
		double dur);							  /* 13 */

void stim_sineann(double speriod, double sphase, double xloc, double yloc,
		double tfreq, double drift, double inten_add, double
		inten_mult, double contrast, double renv, double start, double
		dur);								/* 12 */

void stim_sineann(double speriod, double sphase, double xloc, double yloc,
		double tfreq, double drift, double inten_mult, double contrast,
		double renv, double start, double dur);				/* 11 */
...
void stim_windmill(double speriod, double sphase, double xloc, double yloc,
		...
		double scale, double inten_add, double inten_mult, double contrast,  /* 20 */
...
void stim_windmill(double speriod, double sphase, double xloc, double yloc,
		...
		int sq, double start, double dur, double wavel, double mask, int stimchan); /* 18 */

void stim_windmill(double speriod, double sphase, double xloc, double yloc,
		double tfreq, double drift, double inten_add, double inten_mult, double contrast,
		double renv, int sq, double start, double dur);			  /* 13 */
...
int set2ndmsg (int ctype, int stype, int prect, int postct, int ntype, double maxdist, double gain);
int set2ndmsg (int ctype, int stype, int prect, int postct, int ntype, double maxdist, double gain, double tau);
int set2ndmsg (int ctype, int stype, int prect, int postct, int ntype, double maxdist, 
