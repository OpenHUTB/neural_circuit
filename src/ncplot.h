...
#define CREC_CACONC 25			/* Ca concentration outside */
#define CREC_CAV    26
#define CREC_CAIT   27
#define CREC_CAIP   28
#define CREC_CAIE   29
#define CREC_CAIPE  30
#define CREC_CABUF  31 	
#define CREC_CABUFB 32 	
#define CREC_CAS    33 	
#define CREC_CICR   34 	/* must change NREC in ncsub.h if this goes past 39 */
