...
{
   return findnode(num1, num2, num3, NULLVAL, NULL);
}
/* */
...
{
   return findnode(num1, num2, num3, NULLVAL, str);
}
/* */
...
{
   return findnode(num1, num2, NULLVAL, NULLVAL, str);
}
