...
extern void (*rphd)(int,double,double,double,double,double,double,double,int);
extern void (*rsyd)(synapse*,double,double,double,double,double,double,double,int);
extern void (*rgjd)(double,double,double,double,double,double,double,int);
...
/* for vcolor, lcolor, cacolor: blue - green - yellow - red */
	...
	"color red 0.024 green    0 blue  0.2",
	"color red 0.052 green    0 blue  0.4",
	"color red 0.062 green    0 blue  0.6",
	"color red 0.082 green 0.05 blue  0.8",
	"color red 0.04  green 0.22 blue    1",
	"color red 0     green 0.32 blue  0.95",
	"color red 0     green 0.38 blue  0.92",
	"color red 0     green 0.45 blue  0.9",
	"color red 0     green 0.54 blue  0.8",
	"color red 0     green 0.64 blue  0.75",
	"color red 0     green 0.74 blue  0.7",
	"color red 0     green 0.85 blue  0.5",
	"color red 0     green 0.90 blue  0.3",
	"color red 0     green 0.95 blue  0.1",
	"color red 0     green   1. blue   0",
	"color red 0.05  green   1. blue   0",
	"color red 0.10  green   1. blue   0",
	"color red 0.15  green   1. blue   0",
	"color red 0.20  green   1. blue   0",
	"color red 0.25  green   1. blue   0",
	"color red 0.30  green 0.99 blue   0",
	"color red 0.35  green 0.98 blue   0",
	"color red 0.45  green 0.97 blue   0",
	"color red 0.55  green 0.95 blue   0",
	"color red 0.65  green 0.90 blue   0",
	"color red 0.75  green 0.85 blue   0",
	"color red 0.80  green 0.83 blue   0",
	"color red 0.82  green 0.82 blue   0",
	"color red 0.95  green 0.75 blue   0",
...
/* from /usr/lib/X11/rgb.txt */
	...
	"color red 0.826 green 0.000 blue 0.000", /* red2 */ 
	"color red 0.690 green 0.000 blue 0.000", /* red3 */ 
	"color red 0.502 green 0.000 blue 0.000", /* red4 */ 
	"color red 0.000 green 0.826 blue 0.000", /* green2 */ 
	"color red 0.000 green 0.690 blue 0.000", /* green3 */ 
	"color red 0.000 green 0.502 blue 0.000", /* green4 */ 
	"color red 0.000 green 0.000 blue 0.826", /* blue2 */ 
	"color red 0.000 green 0.000 blue 0.690", /* blue3 */ 
	"color red 0.000 green 0.000 blue 0.502", /* blue4 */ 
	"color red 0.753 green 0.376 blue 0.000", /* brown2 */ 
	"color red 0.627 green 0.251 blue 0.000", /* brown3 */ 
	"color red 0.502 green 0.188 blue 0.000", /* brown4 */ 
	"color red 0.000 green 0.826 blue 0.826", /* cyan2 */ 
	"color red 0.000 green 0.690 blue 0.690", /* cyan3 */ 
	"color red 0.000 green 0.502 blue 0.502", /* cyan4 */ 
	"color red 0.826 green 0.000 blue 0.826", /* magenta2 */ 
	"color red 0.690 green 0.000 blue 0.690", /* magenta3 */ 
	"color red 0.502 green 0.000 blue 0.502", /* magenta4 */ 
};
	...
	double rxcent, double rycent, double rzcent, double scal, int bknd_color)
{
  ...
  ncfprintf (stdout,"  fog {\n");		/* fog sets background color */
  ncfprintf (stdout,"   color %s \n",getcol(bknd_color));
  ncfprintf (stdout,"   distance %12.10g \n",1e9);
  ncfprintf (stdout,"  }\n");		
...
//  color = BLACK; 
  ...
  // color = RED;
  xoffs = strlen(numbuf)*0.5;		/* find center of number */
  rprintf(numbuf,tx-xoffs*0.3*dscale,ty-0.3*dscale,tz+10,dscale,0,color);
	...
	int color, int hide, double (*mat)[4])
{
  ...
  transf (x2,y2,z2,&tx2,&ty2,&tz2,mat);
  dia = 0.5;
  (*rsyd)(epnt,dia,tx1,ty1,tz1,tx2,ty2,tz2,color);
}
	...
	int color, int hide, double (*mat)[4])
{
  ...
  case GJ: (*rgjd)(dscale,tx1,ty1,tz1,tx2,ty2,tz2,(double)color);
    break;
...

{
  ...
  case ITRANSDUCER:
  case CHR:
  case CONE: phtype= "cone"; break;

  case ROD: phtype= "rod"; break;

  }  /* switch */

   ncfprintf (stdout,"object { nc_%s scale <%g,%g,1> rotate <%g,%g,%g> translate <%g,%g,%g> pigment {%s} }\n\n",
 	 phtype, dia,dia,xr,yr,zr,tx1,ty1,tz1,getcol(color));
}
		     ...
		     int color, int hide, double (*mat)[4])
{
  ...
  (*rphd)(ctype,dia,xr,yr,zr,tx1,ty1,tz1,color);
}
...
{
    ncfprintf(stdout,"text { ttf \"timrom.ttf\" \"%s\" 1, 0 scale <%g,%g,1> rotate <0,0,%g> translate <%g,%g,%g> pigment {%s} }\n\n",
  		   fmt,size,size,theta,x,y,z,getcol(color));
}
...
void raycalib(double x, double y, double len, double size, int color)
{
  ...
  rprintf (numbuf, x-len*0.7, y-ls,z,ls,0,color);
