...
int _K8_offm = C_K8*NCH+CHOFFM;      /* Ih, type 8 */
int _K8_offh = C_K8*NCH+CHOFFH;
int _K8_taua = C_K8*NCH+CHTAUA;
int _K8_taub = C_K8*NCH+CHTAUB;
int _K8_tauc = C_K8*NCH+CHTAUC;
int _K8_taud = C_K8*NCH+CHTAUD;

int _K9_offm = C_K9*NCH+CHOFFM;      /* Ih, type 9 */
int _K9_offh = C_K9*NCH+CHOFFH;
int _K9_taua = C_K9*NCH+CHTAUA;
int _K9_taub = C_K9*NCH+CHTAUB;
int _K9_tauc = C_K9*NCH+CHTAUC;
int _K9_taud = C_K9*NCH+CHTAUD;

int _K10_offm = C_K10*NCH+CHOFFM;      /* Ih, type 10 */
int _K10_offh = C_K10*NCH+CHOFFH;
int _K10_taua = C_K10*NCH+CHTAUA;
int _K10_taub = C_K10*NCH+CHTAUB;
int _K10_tauc = C_K10*NCH+CHTAUC;
int _K10_taud = C_K10*NCH+CHTAUD;

int _K11_offm = C_K11*NCH+CHOFFM;      /* Kv3.1b, type 11 */
int _K11_offh = C_K11*NCH+CHOFFH;
int _K11_taua = C_K11*NCH+CHTAUA;
int _K11_taub = C_K11*NCH+CHTAUB;
int _K11_tauc = C_K11*NCH+CHTAUC;
int _K11_taud = C_K11*NCH+CHTAUD;
...
int _ACH1_offm = C_ACH1*NCH+CHOFFM;     /* ACH type 1 */
int _ACH1_offh = C_ACH1*NCH+CHOFFH;
int _ACH1_taua = C_ACH1*NCH+CHTAUA;
int _ACH1_taub = C_ACH1*NCH+CHTAUB;
int _ACH1_tauc = C_ACH1*NCH+CHTAUC;
int _ACH1_taud = C_ACH1*NCH+CHTAUD;
...
int _GLY1_offm = C_GLY1*NCH+CHOFFM;     /* glycine type 1 */
int _GLY1_offh = C_GLY1*NCH+CHOFFH;
int _GLY1_taua = C_GLY1*NCH+CHTAUA;
int _GLY1_taub = C_GLY1*NCH+CHTAUB;
int _GLY1_tauc = C_GLY1*NCH+CHTAUC;
int _GLY1_taud = C_GLY1*NCH+CHTAUD;
...

{
   ...
   setptrn ("K8.offm", &_K8_offm);
   setptrn ("K8.offh", &_K8_offh);
   setptrn ("K8.taua", &_K8_taua);
   setptrn ("K8.taub", &_K8_taub);
   setptrn ("K8.tauc", &_K8_tauc);
   setptrn ("K8.taud", &_K8_taud);

   setptrn ("K9.offm", &_K9_offm);
   setptrn ("K9.offh", &_K9_offh);
   setptrn ("K9.taua", &_K9_taua);
   setptrn ("K9.taub", &_K9_taub);
   setptrn ("K9.tauc", &_K9_tauc);
   setptrn ("K9.taud", &_K9_taud);

   setptrn ("K10.offm", &_K10_offm);
   setptrn ("K10.offh", &_K10_offh);
   setptrn ("K10.taua", &_K10_taua);
   setptrn ("K10.taub", &_K10_taub);
   setptrn ("K10.tauc", &_K10_tauc);
   setptrn ("K10.taud", &_K10_taud);

   setptrn ("K11.offm", &_K11_offm);
   setptrn ("K11.offh", &_K11_offh);
   setptrn ("K11.taua", &_K11_taua);
   setptrn ("K11.taub", &_K11_taub);
   setptrn ("K11.tauc", &_K11_tauc);
   setptrn ("K11.taud", &_K11_taud);
   ...
   setptrn ("GLY1.offm", &_GLY1_offm);
   setptrn ("GLY1.offh", &_GLY1_offh);
   setptrn ("GLY1.taua", &_GLY1_taua);
   setptrn ("GLY1.taub", &_GLY1_taub);
   setptrn ("GLY1.tauc", &_GLY1_tauc);
   setptrn ("GLY1.taud", &_GLY1_taud);
