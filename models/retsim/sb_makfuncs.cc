...
void mak_real_cel(int ct, int cn, int morphfil, double xpos, double ypos, double thetax, 
...
void mak_sbac(int ct, int n, int morphfil, int nden, double xpos, double ypos, double thetax, 
...

{
  ...
  if      (morph==MORPH_REAL) {
	  mak_real_cel (ct,n,morphfil,xpos,ypos,thetax,thetay,sbac_theta,flip,
