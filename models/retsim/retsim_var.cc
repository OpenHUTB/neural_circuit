...
int xach1    = XACH1;		/* ACh  type 1 synaptic response */
...
int xvfb     = XVFB;		/* Voltage feedback (ephaptic or pH) */
...
int _K8  = C_K8;      /* Ih, type 8 */
int _K9  = C_K9;      /* Ih, type 9 */
int _K10 = C_K10;     /* Ih, HCN, type 10 */
int _K11 = C_K11;     /* Kv3.1b, SBAC, type 11 */
...
int _KV3 = C_K11;     /* Kv3.1b, SBAC, type 11 */
int _KV3B = C_K6;     /* Kv3b, SBAC, type 6 */
...
int _GLY1   = C_GLY1;       /* GLY type 1 */

int _VFB    = C_VFB;        /* VFB voltage feedback */
...
int _CADIA  = C_CADIA;   /* ca comp dia */
...
int _COL2   = C_COLOR2;  /* color2 for region */
int _COL3   = C_COLOR3;  /* color3 for region */
int _COL4   = C_COLOR4;  /* color4 for region */
int _COL5   = C_COLOR5;  /* color5 for region */
int _COL6   = C_COLOR6;  /* color6 for region */

int _SREG1  = C_SREG1;   /* synaptic region 1 -> region is part of collection of regions */
int _SREG2  = C_SREG2; 
int _SREG3  = C_SREG3; 
int _SREG4  = C_SREG4; 
int _SREG5  = C_SREG5; 
...
int *celnode[NCELTYPES] = {0};                  /* node number count for all cells of each type */


const char* chname[] = { "Na0", "Na1", "Na2", "Na3", "Na4", "Na5", "Na6", "Na8", 
	"K0", "Kdr", "K2", "KA", "KH", "Kir", "Kv3", "Kv3b", "Ih", "Ih", "HCN", "Kv3.1b",
        "KCa0", "KCa1", "KCa2", "BKCa", "SKCa1", "SKCa2", "KCa6", "ClCa", "ClCaC",
	"Ca0", "Ca1", "Ca2", "Ca3", "Ca4", "Ca5", "Ca6", "Ca7", "NMDA1", "NMDA2", 
	"AMPA", "AMPA2", "AMPA3", "AMPA4", "AMPA5", "ACH", "GABA1", "GABA2", "GABA3", "GABAC", "GLY1", "XVFB",
	"CGMP1", "CGMP2", "CGMP3", "CGMP4", "CGMP5", "CGMP6", "CGMP7", "CGMP8", "CGMP9", "CGMP10", "CGMP11",
	"Capump", "CapumpKm", "CabufVmax", "CabufKd", "Cabuftot", "Cabuftoti", "Cashell", "Cadia", "Caexch", 
	...
	"D4IP3","A2IP3","A3IP3","B2IP3","K3IP3","Vstart", "Vrev", "Rm", "Ri", "Cm", "Dia", "cplam", "condmul",
	"color", "color2", "color3", "color4", "color5", "color6",
	"sreg1", "sreg2", "sreg3", "sreg4", "sreg5", "sreg6", "sreg7", "sreg8", "none" };
...
const char *colornames[NOCOLOR+16] = { "black","blue","green","cyan","red","magenta","brown","white",
...
const char *sbac_file2; 	/* sbac cell anatomy, 2nd morph file */
...
const char *anatfiles[2][NCELTYPES] = {NULL}; /* default anatomy file names */
...
double *haxarr=NULL,  *hayarr=NULL,  *hatharr=NULL;
double *hbxarr=NULL,  *hbyarr=NULL,  *hbtharr=NULL;
double *hbatxarr=NULL, *hbatyarr=NULL, *hbattharr=NULL;
...
int *amhnarr=NULL, *amh2narr=NULL, *amsnarr=NULL, *amnarr=NULL, *am2narr=NULL, *am3narr=NULL, *am4narr=NULL, *aiinarr=NULL, *sbnarr=NULL, *a17narr=NULL, *hanarr=NULL, *hbnarr=NULL, *hbatnarr=NULL, *dbp1narr=NULL, *dbp2narr=NULL, *dbp3narr=NULL, *dbp4narr=NULL, *hbp1narr=NULL, *hbp2narr=NULL, *rodnarr=NULL, *conenarr=NULL, *rbpnarr=NULL, *gcnarr=NULL;
...

{
   ...
   setptrn("xach1",    &xach1);		/* ACH  type 1 synaptic response */
   ...
   setptrn("xvfb",     &xvfb);		/* voltage feedback */
...
#include "nval_var_set.cc"
   ...
   setptrn ("_COL5",   &_COL5);
   setptrn ("_COL6",   &_COL6);
   setptrn ("_SREG1",  &_SREG1);
   setptrn ("_SREG2",  &_SREG2);
   setptrn ("_SREG3",  &_SREG3);
   setptrn ("_SREG4",  &_SREG4);
   setptrn ("_SREG5",  &_SREG5);
   setptrn ("_SREG6",  &_SREG6);
   setptrn ("_SREG7",  &_SREG7);
   setptrn ("_SREG8",  &_SREG8);
   ...
   setptrn("make_cone_rod",  &make_cone_rod);
   ...
   setptrn("make_rod_hb",    &make_rod_hb);
   ...
   setptrn("make_ams_sbac",  &make_ams_sbac);
   ...
   setptrn("make_am2_gcaoff",&make_am2_gcaoff);
   ...
   setptrn("make_am2_dsgc",  &make_am2_dsgc);
   ...
   setptrn("make_hb_cone",   &make_hb_cone);
   setptrn("make_hb_rod",    &make_hb_rod);
   setptrn("make_hbat_rod",  &make_hbat_rod);
   ...
   setptr("haarrsiz",&haarrsiz);
   setptr("haxarrsiz",&haxarrsiz);
   setptr("hayarrsiz",&hayarrsiz);
   setptr("hbarrsiz",&hbarrsiz);
   setptr("hbxarrsiz",&hbxarrsiz);
   setptr("hbyarrsiz",&hbyarrsiz);
   setptr("hbatarrsiz",&hbatarrsiz);
   setptr("hbatxarrsiz",&hbatxarrsiz);
   setptr("hbatyarrsiz",&hbatyarrsiz);
   ...
   setptr("sbac_first_cent",&sbac_first_cent);
   ...
   setptr("disp_calib_x",&disp_calib_x);
   setptr("disp_calib_y",&disp_calib_y);
   ...
   setptr("cone_stimchan", &cone_stimchan);
   setptr("rod_stimchan",  &rod_stimchan);
