...
/* Script to create neuron parameter file.
   ...
   Note: 
      ...
      To remove one column from an existing nval.n file, use nval_subcol
*/
...
#define PNAMSIZ 600			/* neural parameters */
...
NCMAP     = makn("NCMAP",		"color map for color of this cell type");
...
SOMAZ2    = makn("SOMAZ2",		"Z location for 2nd morph (x,y loc determ. by array)");
...
DTIPLEN   = makn("DTIPLEN",		"length of dendritic tips");
DTREEDIA  = makn("DTREEDIA",		"diameter of dendritic tree");
ARBSCALE  = makn("ARBSCALE",		"scale for dia of real morph dend tree");
ARBSCALE2 = makn("ARBSCALE2",		"scale for dia of 2nd real morph dend tree");
DENDDIA   = makn("DENDDIA",		"dend dia scale for real morph");
DENDDIA2  = makn("DENDDIA2",		"dend dia scale for 2nd real morph");
...
SYNANG1   = makn("SYNANG1",		"angle for presynaptic node rel to soma");
SYNRNG1   = makn("SYNRNG1",		"range of presyn dendritic angles");
...
CAEGAIN1  = makn("CAEGAIN1",		"synaptic release calcium exponential sensitivity");
...
SDURH1    = makn("SDURH1",		"synaptic high pass time const. (ms)");
...
SDUR1     = makn("SDUR1",		"synaptic event time const. (ms)");
SFALL1    = makn("SFALL1",		"synaptic event fall time const. (ms)");
...
SVFBG1    = makn("SVFBG1",		"synaptic voltage feedback gain");
SVFBO1    = makn("SVFBO1",		"synaptic voltage feedback offset");
SCNFILT1  = makn("SCNFILT1",		"second mesng. nfilt");
SCDUR1    = makn("SCDUR1",		"second mesng. time const. (ms)");
...
SYNANG2   = makn("SYNANG2",		"angle for presynaptic node rel to soma");
SYNRNG2   = makn("SYNRNG2",		"range of presyn dendritic angles");
...
CAEGAIN2  = makn("CAEGAIN2",		"synaptic release calcium exponential sensitivity");
...
SDURH2    = makn("SDURH2",		"synaptic high pass time const. (ms)");
...
SDUR2     = makn("SDUR2",		"synaptic event time const. (ms)");
SFALL2    = makn("SFALL2",		"synaptic event fall time const. (ms)");
...
SVFBG2    = makn("SVFBG2",		"synaptic voltage feedback gain");
SVFBO2    = makn("SVFBO2",		"synaptic voltage feedback offset");
SCNFILT2  = makn("SCNFILT2",		"second mesng. nfilt");
SCDUR2    = makn("SCDUR2",		"second mesng. time const. (ms)");
...
SYNANG3   = makn("SYNANG3",		"angle for presynaptic node rel to soma");
SYNRNG3   = makn("SYNRNG3",		"range of presyn dendritic angles");
...
CAEGAIN3  = makn("CAEGAIN3",		"synaptic release calcium exponential sensitivity");
...
SDURH3    = makn("SDURH3",		"synaptic high pass time const. (ms)");
...
SDUR3     = makn("SDUR3",		"synaptic event time const. (ms)");
SFALL3    = makn("SFALL3",		"synaptic event fall time const. (ms)");
...
SVFBG3    = makn("SVFBG3",		"synaptic voltage feedback gain");
SVFBO3    = makn("SVFBO3",		"synaptic voltage feedback offset");
SCNFILT3  = makn("SCNFILT3",		"second mesng. nfilt");
SCDUR3    = makn("SCDUR3",		"second mesng. time const. (ms)");
...
SYNANG4   = makn("SYNANG4",		"angle for presynaptic node rel to soma");
SYNRNG4   = makn("SYNRNG4",		"range of presyn dendritic angles");
...
CAEGAIN4  = makn("CAEGAIN4",		"synaptic release calcium exponential sensitivity");
...
SDURH4    = makn("SDURH4",		"synaptic high pass time const. (ms)");
...
SDUR4     = makn("SDUR4",		"synaptic event time const. (ms)");
SFALL4    = makn("SFALL4",		"synaptic event fall time const. (ms)");
...
SVFBG4    = makn("SVFBG4",		"synaptic voltage feedback gain");
SVFBO4    = makn("SVFBO4",		"synaptic voltage feedback offset");
SCNFILT4  = makn("SCNFILT4",		"second mesng. nfilt");
SCDUR4    = makn("SCDUR4",		"second mesng. time const. (ms)");
...
SYNANG5   = makn("SYNANG5",		"angle for presynaptic node rel to soma");
SYNRNG5   = makn("SYNRNG5",		"range of presyn dendritic angles");
...
CAEGAIN5  = makn("CAEGAIN5",		"synaptic release calcium exponential sensitivity");
...
SDURH5    = makn("SDURH5",		"synaptic high pass time const. (ms)");
...
SDUR5     = makn("SDUR5",		"synaptic event time const. (ms)");
SFALL5    = makn("SFALL5",		"synaptic event fall time const. (ms)");
...
SVFBG5    = makn("SVFBG5",		"synaptic voltage feedback gain");
SVFBO5    = makn("SVFBO5",		"synaptic voltage feedback offset");
SCNFILT5  = makn("SCNFILT5",		"second mesng. nfilt");
SCDUR5    = makn("SCDUR5",		"second mesng. time const. (ms)");
...
SYNANG6   = makn("SYNANG6",		"angle for presynaptic node rel to soma");
SYNRNG6   = makn("SYNRNG6",		"range of presyn dendritic angles");
...
CAEGAIN6  = makn("CAEGAIN6",		"synaptic release calcium exponential sensitivity");
...
SDURH6    = makn("SDURH6",		"synaptic high pass time const. (ms)");
...
SDUR6     = makn("SDUR6",		"synaptic event time const. (ms)");
SFALL6    = makn("SFALL6",		"synaptic event fall time const. (ms)");
...
SVFBG6    = makn("SVFBG6",		"synaptic voltage feedback gain");
SVFBO6    = makn("SVFBO6",		"synaptic voltage feedback offset");
SCNFILT6  = makn("SCNFILT6",		"second mesng. nfilt");
SCDUR6    = makn("SCDUR6",		"second mesng. time const. (ms)");
...
SYNANG7   = makn("SYNANG7",		"angle for presynaptic node rel to soma");
SYNRNG7   = makn("SYNRNG7",		"range of presyn dendritic angles");
...
CAEGAIN7  = makn("CAEGAIN7",		"synaptic release calcium exponential sensitivity");
...
SDURH7    = makn("SDURH7",		"synaptic high pass time const. (ms)");
...
SDUR7     = makn("SDUR7",		"synaptic event time const. (ms)");
SFALL7    = makn("SFALL7",		"synaptic event fall time const. (ms)");
...
SVFBG7    = makn("SVFBG7",		"synaptic voltage feedback gain");
SVFBO7    = makn("SVFBO7",		"synaptic voltage feedback offset");
SCNFILT7  = makn("SCNFILT7",		"second mesng. nfilt");
SCDUR7    = makn("SCDUR7",		"second mesng. time const. (ms)");
...
SYNANG8   = makn("SYNANG8",		"angle for presynaptic node rel to soma");
SYNRNG8   = makn("SYNRNG8",		"range of presyn dendritic angles");
...
CAEGAIN8  = makn("CAEGAIN8",		"synaptic release calcium exponential sensitivity");
...
SDURH8    = makn("SDURH8",		"synaptic high pass time const. (ms)");
...
SDUR8     = makn("SDUR8",		"synaptic event time const. (ms)");
SFALL8    = makn("SFALL8",		"synaptic event fall time const. (ms)");
...
SVFBG8    = makn("SVFBG8",		"synaptic voltage feedback gain");
SVFBO8    = makn("SVFBO8",		"synaptic voltage feedback offset");
SCNFILT8  = makn("SCNFILT8",		"second mesng. nfilt");
SCDUR8    = makn("SCDUR8",		"second mesng. time const. (ms)");
...
SYNANG9   = makn("SYNANG9",		"angle for presynaptic node rel to soma");
SYNRNG9   = makn("SYNRNG9",		"range of presyn dendritic angles");
...
CAEGAIN9  = makn("CAEGAIN9",		"synaptic release calcium exponential sensitivity");
...
SDURH9    = makn("SDURH9",		"synaptic high pass time const. (ms)");
...
SDUR9     = makn("SDUR9",		"synaptic event time const. (ms)");
SFALL9    = makn("SFALL9",		"synaptic event fall time const. (ms)");
...
SVFBG9    = makn("SVFBG9",		"synaptic voltage feedback gain");
SVFBO9    = makn("SVFBO9",		"synaptic voltage feedback offset");
SCNFILT9  = makn("SCNFILT9",		"second mesng. nfilt");
SCDUR9    = makn("SCDUR9",		"second mesng. time const. (ms)");
...
xach1     = makr("XACH1",		"/* nicotinic ACh synaptic response */");
...
xvfb      = makr("XVFB",		"/* voltage feedback (ephaptic or pH) */");
...
SYNANG   = maks("SYNANG",		"/* angle for presynaptic node rel to soma */");
SYNRNG   = maks("SYNRNG",		"/* range of presyn dendritic angles */");
...
CAEGAIN  = maks("CAEGAIN",		"/* synaptic release calcium exponential sensitivity */");
...
SDURH    = maks("SDURH",		"/* synaptic high pass time const. (ms) */");
...
SDUR     = maks("SDUR",			"/* synaptic event time const. (ms) */");
SFALL    = maks("SFALL",		"/* synaptic event fall time const. (ms) */");
...
SVFBG    = maks("SVFBG",		"/* synaptic voltage feedback gain */");
SVFBO    = maks("SVFBO",		"/* synaptic voltage feedback offset */");
SCNFILT  = maks("SCNFILT",		"/* second mesng. nfilt */");
SCDUR    = maks("SCDUR",		"/* second mesng. time const. (ms) */");
...
/*-----------------------------------------*/
  ...
  nval(xrod,  DTIPLEN) = 0.0;
  nval(xcone, DTIPLEN) = 0.0;
  nval(ha,    DTIPLEN) = 3.0;	/* dendritic tip diameters */
  nval(hb,    DTIPLEN) = 3.0;
  nval(hbat,  DTIPLEN) = 0.0;
  nval(rbp,   DTIPLEN) = 0.0;
  nval(dbp1,  DTIPLEN) = 0.0;
  nval(dbp2,  DTIPLEN) = 0.0;
  nval(dbp3,  DTIPLEN) = 0.0;
  nval(dbp4,  DTIPLEN) = 0.0;
  nval(hbp1,  DTIPLEN) = 0.0;
  nval(hbp2,  DTIPLEN) = 0.0;
  nval(a17,   DTIPLEN) = 0.0;
  nval(aii,   DTIPLEN) = 0.0;
  nval(sbac,  DTIPLEN) = 0.0;
  nval(am,    DTIPLEN) = 0.0;
  nval(am2,   DTIPLEN) = 0.0;
  nval(am3,   DTIPLEN) = 0.0;
  nval(am4,   DTIPLEN) = 0.0;
  nval(amh,   DTIPLEN) = 0.0;
  nval(amh2,  DTIPLEN) = 0.0;
  nval(ams,   DTIPLEN) = 0.0;
  nval(amhs,  DTIPLEN) = 0.0;
  nval(gca,   DTIPLEN) = 0.0;
  nval(gcb,   DTIPLEN) = 0.0;
  nval(dsgc,  DTIPLEN) = 0.0;
  nval(gcaoff,DTIPLEN) = 0.0;
  nval(gcboff,DTIPLEN) = 0.0;
  ...
  for (n=0; n<nceltypes; n++) {      /* set synaptic params to defaults */
    for (k=j=0; j<NCONNO; j++,k+=NSYNP){ 
      ...
      nval(n,k+SYNANG1)  = 0;	     /* angle for presynaptic node rel to soma */
      nval(n,k+SYNRNG1)  = 0;	     /* range of presyn dendritic angles */
      ...
      nval(n,k+CAEGAIN1) = 1;	     /* synaptic exponential sensitivity to calcium */
      ...
      nval(n,k+SVFBG)	 = 0;	     /* synaptic voltage feedback gain . */
      nval(n,k+SVFBO)	 = 0;	     /* synaptic voltage feedback offset. */
  ...
  nval(xcone, SYNANG1) = 0;		/* angle for presynaptic node rel to soma */
  nval(xrod,  SYNANG1) = 0;
  nval(ha,    SYNANG1) = 0;
  nval(hb,    SYNANG1) = 0;
  nval(hbat,  SYNANG1) = 0;
  ...
  nval(xcone, SYNRNG1) = 0;		/* range of presyn dendritic angles */
  nval(xrod,  SYNRNG1) = 0;
  nval(ha,    SYNRNG1) = 0;
  nval(hb,    SYNRNG1) = 0;
  nval(hbat,  SYNRNG1) = 0;
  ...
  nval(xcone,CELDIV7)  = 5;		/* number of postsyn cells to conn to */
  nval(xcone,GROWPRE7) = 0;		/* grow when making conn to postsyn cell */
  nval(xcone,SYNNUM7)  = 1;		/* number of synapses per conn */
  nval(xcone,SRESP7)   = xgapj;		/* synaptic response */
  nval(xcone,SGAIN7)   = 1;	  	/* synaptic gain */
  ...
  nval(xcone,CELCONV3)  = 5;		/* number of postsyn cells to connect to */

  nval(xcone,CELPOST8) = xrod;	  	/* cell type to connect to */
  nval(xcone,CONPOST8) = 2;	  	/* connection number */
  nval(xcone,CELDIV8)  = 10;	  	/* number of postsyn cells to conn to */
  nval(xcone,SYNNUM8)  = 1;	  	/* number of synapses per conn */
  nval(xcone,SRESP8)   = xgapj;		/* synaptic response */
  nval(xcone,SGAIN8)   = 1;	  	/* synaptic gain */
  nval(xcone,SCGAIN8)  = 1;	  	/* synaptic second messenger gain */
  nval(xcone,SCOND8)   = 200e-12;  	/* synaptic conductance */
  nval(xcone,STHRESH8) = -0.05;  	/* synaptic release threshold */
  nval(xcone,SNCHAN8)  = 20;	  	/* number of channels */
  nval(xcone,SDUR8)    = 2;	  	/* synaptic event time const. */
  nval(xcone,SCDUR8)   = 1;	  	/* second mesng. time const. */
  ...
  nval(xrod,CELPRE2)   = xcone;	  	/* presynaptic cell type */
  nval(xrod,CONPRE2)   = 8;	  	/* presynaptic connection number */
  nval(xrod,CELCONV2)  = 5;		/* number of presyn cells to connect to */

  nval(xcone,CELPOST9) = dbp3;	  	/* cell type to connect to */
  nval(xcone,CONPOST9) = 1;	  	/* connection number */
  nval(xcone,CELDIV9)  = 2;	  	/* number of postsyn cells to conn to */
  nval(xcone,SYNNUM9)  = 1;	  	/* number of synapses per conn */
  nval(xcone,SRESP9)   = xmglur6;	/* synaptic response */
  nval(xcone,SGAIN9)   = 3;	  	/* synaptic gain */
  nval(xcone,SVGAIN9)  = 1;	  	/* synaptic vgain */
  nval(xcone,SCGAIN9)  = 1.6;	  	/* synaptic second messenger gain */
  nval(xcone,SCOFF9)   = 1;	  	/* synaptic second messenger offset */
  nval(xcone,SCOND9)   = 2e-10;  	/* synaptic conductance */
  nval(xcone,SVREV9)   = 0;	  	/* synaptic reversal potential */
  nval(xcone,STHRESH9) = -0.0290;  	/* synaptic release threshold */
  nval(xcone,SNCHAN9)  = 20;	  	/* number of channels */
  nval(xcone,SDUR9)    = 2;	  	/* synaptic event time const. */
  nval(xcone,SCDUR9)   = 2;	  	/* second mesng. time const. */
  nval(xcone,SCNFILT9) = 2;	  	/* second mesng. number of filters. */
  nval(xcone,SVSIZ9)   = 1.0;	  	/* synaptic vesicle size */
  nval(xcone,SUNIT9)   = 22e-12;  	/* unitary conductance */
  nval(xcone,STRCONC9) = 0.0009;	/* synaptic neurotransmitter conc */

  nval(dbp3,CELPRE1)   = xcone;	  	/* presynaptic cell type */
  nval(dbp3,CONPRE1)   = 9;	  	/* presynaptic connection number */
  ...
  nval(xrod,CELPOST3) = xcone;	  	/* cell type to connect to */
  nval(xrod,CONPOST3) = 4;	  	/* connection number */
  nval(xrod,CELDIV3)  = 5;	  	/* number of postsyn cells to conn to */
  nval(xrod,SYNNUM3)  = 1;	  	/* number of synapses per conn */
  nval(xrod,SRESP3)   = xgapj;		/* synaptic response */
  nval(xrod,SGAIN3)   = 1;	  	/* synaptic gain */
  nval(xrod,SCGAIN3)  = 1;	  	/* synaptic second messenger gain */
  nval(xrod,SCOND3)   = 200e-12;  	/* synaptic conductance */
  nval(xrod,STHRESH3) = -0.05;  	/* synaptic release threshold */
  nval(xrod,SNCHAN3)  = 20;	  	/* number of channels */
  nval(xrod,SDUR3)    = 2;	  	/* synaptic event time const. */
  nval(xrod,SCDUR3)   = 1;	  	/* second mesng. time const. */
  nval(xrod,SVSIZ3)   = 1.0;	  	/* synaptic vesicle size */
  nval(xrod,SUNIT3)   = 22e-12;  	/* unitary conductance */
  nval(xrod,SVREV3)   = 0;	  	/* synaptic reversal potential */

  nval(xcone,CELPRE4)   = xrod;	  	/* presynaptic cell type */
  nval(xcone,CONPRE4)   = 3;	  	/* presynaptic connection number */
  nval(xcone,CELCONV4)  = 10;		/* number of presyn cells to connect to */
...
/*--------------------------------------------*/
  ...
  printf ("#\n");
  printf ("#    Original created by \"maknval > nval.n\"\n");
