...
extern const char *anatfiles[2][NCELTYPES];		/* cell anatomy file names */
...
extern int *celnode[NCELTYPES];			/* node number count for all cells of each type */
...
extern int make_am2_gcaoff;
extern int make_am_dsgc;
extern int make_am2_dsgc;
...
extern int make_hb_cone;
extern int make_hb_rod;
extern int make_hbat_rod;
...
/* variables to define the rows in dens_xxx.n files */
...
extern int _SREG1;	/* rows defining collection of regions in density file */
extern int _SREG2;
extern int _SREG3;
extern int _SREG4;
extern int _SREG5;
...
extern double haarrsiz;
extern double haxarrsiz;
extern double hayarrsiz;
extern double hbarrsiz;
extern double hbxarrsiz;
extern double hbyarrsiz;
extern double hbatarrsiz;
extern double hbatxarrsiz;
extern double hbatyarrsiz;
...
extern int *aiinarr;
extern double *haxarr;
extern double *hayarr;
extern double *hatharr;
extern int *hanarr;
extern double *hbxarr;
extern double *hbyarr;
extern double *hbtharr;
extern int *hbnarr;
extern double *hbatxarr;
extern double *hbatyarr;
extern double *hbattharr;
extern int *hbatnarr;
...
extern int cone_stimchan;
extern int rod_stimchan;
...
extern double disp_calib_x;
extern double disp_calib_y;
