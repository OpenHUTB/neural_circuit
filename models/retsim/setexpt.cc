...
void (*addsyns)(void)=nullfunc;		/* Add extra synapses */
                                	/*  defined in the experiment file */
...
#define XBUFSIZ 100
  ...
  strncat (exptlib,expt,XBUFSIZ-1);
// #ifdef MACOSX
...
// #endif
  ...
  tempfunc = (void (*)(void)) dlsym(lib_handle, "_Z7addsynsv");
   if ((error = dlerror()) == NULL)  { addsyns = tempfunc; }
