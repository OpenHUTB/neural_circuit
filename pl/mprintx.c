...
double ccols[NCCOLS][3] = { 
	...
	0.826, 0.000, 0.000,		/* red2 */
	0.690, 0.000, 0.000,		/* red3 */
	0.502, 0.000, 0.000,		/* red4 */
	0.000, 0.826, 0.000,		/* green2 */
	0.000, 0.690, 0.000,		/* green3 */
	0.000, 0.502, 0.000,		/* green4 */
	0.000, 0.000, 0.826,		/* blue2 */
	0.000, 0.000, 0.690,		/* blue3 */
	0.000, 0.000, 0.502,		/* blue4 */
	0.753, 0.376, 0.000,		/* brown2 */
	0.627, 0.251, 0.000,		/* brown3 */
	0.502, 0.188, 0.000,		/* brown4 */
	0.000, 0.826, 0.826,		/* cyan2 */
	0.000, 0.690, 0.690,		/* cyan3 */
	0.000, 0.502, 0.502,		/* cyan4 */
	0.826, 0.000, 0.826,		/* magenta2 */
	0.690, 0.000, 0.690,		/* magenta3 */
	0.502, 0.000, 0.502,		/* magenta4 */
};
...
int setxcol(int pen)
{
  ...
  if (backgr == BLACK && pen==BLACK) pen = WHITE;
  scrcolor = pen;
  oldcol = pen;
  return temp;
}
