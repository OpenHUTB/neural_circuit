...
char *_fmatch(char *fname, char *fpath);
char *_path(struct _frame *fp, char *buf); 
...
void _draw(double,double), _window(double,double,double,double,struct _frame*);
...
void _cat();
void fat(int), cpen(int), dashf(float*), dash(long int), _vertextf(char*);
